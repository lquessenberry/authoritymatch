      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Newly matched truckers synchronized into the company dashboard and ready
            for export into connected systems.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-border bg-card">
        ...
        <div className="p-6">
          <p className="text-muted-foreground text-sm text-center py-8">
            ...
            to receive matched leads and seed the export-ready dashboard feed.
          </p>
        </div>
      </div>
    </div>
